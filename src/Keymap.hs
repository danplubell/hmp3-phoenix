...
import           Core
import           Curses                (keyBackspace, keyDown, keyEnd, keyHome,
                                        keyLeft, keyNPage, keyPPage, keyRight,
                                        keyUp)
import           Lexers                (Lexer, Regexp, action, alt, char,
                                        execLexer, meta, with, (>|<), (>||<))
import           State                 (HState (helpVisible), getsST, touchST)
